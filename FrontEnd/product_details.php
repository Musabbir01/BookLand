                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="product_categories.php?id=<?php echo $get_product['0']['categories_id']?>">Same Category Products</a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li><a href="product_categories.php?id=<?php echo $get_product['0']['categories_id']?>"><?php echo $get_product['0']['categories']?></a></li>
                                        </ul>
                                    </div>
